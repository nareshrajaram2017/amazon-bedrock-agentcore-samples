...
memory_client = boto3.client("bedrock-agentcore-control")


def get_namespaces(client: MemoryClient, memory_id: str) -> Dict:
...
def setup_memory():
    ...
    return CustomerSupportMemoryHooks(memory_id, MemoryClient(), ACTOR_ID, SESSION_ID)
